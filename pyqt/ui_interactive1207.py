...
from PyQt5.QtWidgets import QDialog, QMainWindow, QApplication, QSlider, QFileDialog, QLabel, QPushButton, QFrame, QTextEdit, QProgressBar, QAction, QTableWidget, QTableWidgetItem, QHeaderView, QStyledItemDelegate, QTableView
...
class Ui(QMainWindow):
    def __init__(self):
        ...
        # self.startInference.setStyleSheet("background-color : primaryColor")


# pushButton_warning.setProperty('class', 'warning')
        self.startInference.setProperty('class', 'warning')

        # self.startInference.setStyleSheet(
        #     "background-color : sdgsdg")
...
class MainWindow(QMainWindow):
    ...
    def updateInferenceStatus(self, status):
        ...
        # self.ui.PLAY.setProperty('class', 'success')
        print('test')
