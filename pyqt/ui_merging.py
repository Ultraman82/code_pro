...
from PyQt5.QtWidgets import QDialog, QGraphicsView, QMainWindow, QApplication, QSlider, QFileDialog, QLabel, QPushButton, QFrame, QTextEdit, QProgressBar, QAction
...
class Ui(QMainWindow):
    def __init__(self):
        ...
        apply_stylesheet(self, list_themes()[5])
        # 1
